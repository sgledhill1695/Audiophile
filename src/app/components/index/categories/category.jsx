...
export default function Category({imageSource, url}){
    ...
    return(
        <>
            <div className="bg-[#F1F1F1] w-[327px] md:w-[223px] md:min-w-[223px] lg:w-[350px] lg:max-w-[350px] h-[165px] flex flex-col items-center justify-end relative  rounded-[8px]">
